		...
		<view class="cate-mask" :class="cateMaskState===0 ? 'none' : cateMaskState===1 ? 'show' : ''" @click="toggleCateMask">
			<view class="cate-content" @click.stop.prevent="stopPrevent" @touchmove.stop.prevent="stopPrevent">
				<scroll-view scroll-y class="cate-list">
					<view v-for="item in cateList" :key="item.category.id">
						<view class="cate-item b-b two">{{item.category.name}}</view>
						<view v-for="tItem in item.children" :key="tItem.id" class="cate-item b-b" :class="{active: tItem.id==searchParam.id}"
...
<script>
	...
	export default {
		...
		onLoad(options) {
			...
			this.searchParam.key = "product_category_id"
			this.searchParam.id = options.sid;
