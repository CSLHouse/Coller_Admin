		...
		computed: {
			...
			timeStyle() {
				...
				return {
					...
					width: `${fontSize * 22 / 14}upx`, // 按字体大小为 14upx 时的比例缩放
 					lineHeight: `${fontSize * 20 / 14}upx`,
					borderRadius: `${fontSize * 3 / 14}upx`,
				}
			},
			splitorStyle() {
				...
				return {
					color: splitorColor,
					fontSize: `${fontSize * 12 / 14}upx`,
					margin: backgroundColor ? `${fontSize * 4 / 14}upx` : ''
				}
			}
		},
		watch: {
