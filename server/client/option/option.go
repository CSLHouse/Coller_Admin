...
func (w withSignerOption) Apply(o *pay.DialSettings) error {
	o.Signer = w.Signer
	return nil
}
...
// Apply 将配置添加到 core.DialSettings 中
func (w withValidatorOption) Apply(o *pay.DialSettings) error {
...
func WithWechatPayCertificate(certificateList []*x509.Certificate) core.ClientOption {
	verifier := verifiers.NewSHA256WithRSAVerifier(pay.NewCertificateMapWithList(certificateList))
...
// Apply 将配置添加到 core.DialSettings 中
func (w withHTTPClientOption) Apply(o *pay.DialSettings) error {
...
// Apply 将配置添加到 core.DialSettings 中
func (w withCipherOption) Apply(o *pay.DialSettings) error {
	o.Cipher = w.Cipher
	return nil
}
