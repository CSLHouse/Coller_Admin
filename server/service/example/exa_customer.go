...
func (exa *CustomerService) GetExaCustomer(id int) (customer example.ExaCustomer, err error) {
...
func (exa *CustomerService) GetCustomerInfoList(sysUserAuthorityID int, info request.PageInfo) (list interface{}, total int64, err error) {
	limit := info.PageSize
