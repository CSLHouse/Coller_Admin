...
type Order struct {
	...
	DeliveryCompany       string       `json:"deliveryCompany" gorm:"null;default null;comment:物流公司(配送方式);"`
	DeliverySn            string       `json:"deliverySn" gorm:"null;default null;comment:物流单号;"`
...
type OrderItem struct {
	...
	RealAmount        float32 `json:"realAmount" gorm:"null;default null;comment:该商品经过优惠后的分解金额;"`
	GiftIntegration   int     `json:"giftIntegration" gorm:"null;default null;"`
	GiftGrowth        int     `json:"giftGrowth" gorm:"null;default null;"`
}
