...
func (i *initMenuAuthority) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	//if err = db.Model(&authorities[1]).Association("SysBaseMenus").Append(menus[10:21]); err != nil {
	//	return next, err
	//}
	...
	//if err = db.Model(&authorities[2]).Association("SysBaseMenus").Append(menus[6:7]); err != nil {
	//	return next, err
	//}
	return next, nil
}
