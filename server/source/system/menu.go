...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: "17", Path: "consumeRegister", Name: "consumeRegister", Component: "view/shop/consumeRegister/consumeRegister.vue", Sort: 1, Meta: Meta{Title: "消费登记", Icon: "ShoppingCart"}},
		{MenuLevel: 0, Hidden: false, ParentId: "17", Path: "consumeList", Name: "consumeList", Component: "view/shop/consumeList/consumeList.vue", Sort: 2, Meta: Meta{Title: "消费列表", Icon: "Reading"}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: "20", Path: "statistics", Name: "Statistics", Component: "view/orderManage/Statistics/Statistics.vue", Sort: 4, Meta: Meta{Title: "数据统计", Icon: "Collection"}},
		{MenuLevel: 0, Hidden: false, ParentId: "20", Path: "orderView", Name: "orderView", Component: "view/orderManage/orderView/orderView.vue", Sort: 4, Meta: Meta{Title: "订单查看", Icon: "Reading"}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: "23", Path: "productList", Name: "ProductList", Component: "view/product/productList/ProductList.vue", Sort: 1, Meta: Meta{Title: "商品列表", Icon: "Box"}},
		{MenuLevel: 0, Hidden: false, ParentId: "23", Path: "newProduct", Name: "NewProduct", Component: "view/product/newProduct/NewProduct.vue", Sort: 2, Meta: Meta{Title: "添加商品", Icon: "Sell"}},
		{MenuLevel: 0, Hidden: false, ParentId: "23", Path: "productCategories", Name: "ProductCategories", Component: "view/product/productCategories/ProductCategories.vue", Sort: 3, Meta: Meta{Title: "商品分类", Icon: "Paperclip"}},
		{MenuLevel: 0, Hidden: false, ParentId: "23", Path: "productType", Name: "ProductType", Component: "view/product/productType/ProductType.vue", Sort: 4, Meta: Meta{Title: "商品类型", Icon: "MagicStick"}},
		{MenuLevel: 0, Hidden: false, ParentId: "23", Path: "brand", Name: "Brand", Component: "view/product/brand/Brand.vue", Sort: 5, Meta: Meta{Title: "品牌管理", Icon: "Medal"}},
		{MenuLevel: 0, Hidden: false, ParentId: "23", Path: "attribute", Name: "Attribute", Component: "view/product/attribute/Attribute.vue", Sort: 6, Meta: Meta{Title: "商品属性参数", Icon: "Medal"}},
		...
		//{MenuLevel: 0, Hidden: false, ParentId: "31", Path: "newRecommend", Name: "NewRecommend", Component: "view/marketing/newRecommend/NewRecommend.vue", Sort: 5, Meta: Meta{Title: "新品推荐", Icon: "Medal"}},
