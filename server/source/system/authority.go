...
func (i *initAuthority) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysAuthority{
		...
		{AuthorityId: 8881, AuthorityName: "管理员", ParentId: utils.Pointer[uint](888), DefaultRouter: "dashboard"},
		{AuthorityId: 9528, AuthorityName: "普通用户", ParentId: utils.Pointer[uint](0), DefaultRouter: "dashboard"},
	}
