...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/product/content", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/product/content", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/product/content", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/product/content", V2: "DELETE"},
		...
		{Ptype: "p", V0: "888", V1: "/product/hotProduct", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/product/hotProduct", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/product/hotProduct", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/product/hotProduct", V2: "GET"},
		...
		{Ptype: "p", V0: "9528", V1: "/product/cart", V2: "POST"},
		{Ptype: "p", V0: "9528", V1: "/product/cart", V2: "DELETE"},
		{Ptype: "p", V0: "9528", V1: "/product/carts", V2: "DELETE"},
		{Ptype: "p", V0: "9528", V1: "/product/cart/list", V2: "GET"},
		{Ptype: "p", V0: "9528", V1: "/product/cart/clear", V2: "DELETE"},
		{Ptype: "p", V0: "9528", V1: "/product/cart", V2: "PUT"},
