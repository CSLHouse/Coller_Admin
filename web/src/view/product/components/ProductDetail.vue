        ...
        <div v-if="active==1">
            <el-form
                ...
                <el-form-item label="赠送积分" prop="date" >
                    <el-input v-model.number="productForm.value.giftPoint" type="number" autocomplete="off" style="width: 100px"/>
                </el-form-item>
                <el-form-item label="赠送成长值" prop="cardId">
                    <el-input v-model.number="productForm.value.giftGrowth" type="number" autocomplete="off" style="width: 100px"/>
                </el-form-item>
                <el-form-item label="积分购买限制" prop="telephone">
                    <el-input v-model.number="productForm.value.usePointLimit" type="number" autocomplete="off" style="width: 100px"/>
                </el-form-item>
                <el-form-item label="预告商品" prop="telephone">
                    <el-switch
                        v-model="productForm.value.previewStatus"
                        :active-value="1"
                        :inactive-value="0">
                    </el-switch>
                </el-form-item>
                <el-form-item label="商品上架" prop="telephone">
                    <el-switch
                        v-model="productForm.value.publishStatus"
                        :active-value="1"
                        :inactive-value="0">
                    </el-switch>
                </el-form-item>
                <el-form-item label="商品推荐" prop="telephone">
                    <el-switch
                        v-model="productForm.value.newStatus"
                        :active-value="1"
                        :inactive-value="0"
                        inactive-text="新品:">
                    </el-switch>
                    <el-switch
                        v-model="productForm.value.recommandStatus"
                        :active-value="1"
                        :inactive-value="0"
                        inactive-text="推荐:">
                    </el-switch>
                ...
                <el-form-item label="详细页标题" prop="name">
                    <el-input v-model="productForm.value.detailTitle" type="text" autocomplete="off" />
                </el-form-item>
                <el-form-item label="详细页描述" prop="name">
                    <el-input v-model="productForm.value.detailDesc" type="text" autocomplete="off" />
                </el-form-item>
                <el-form-item label="商品关键字" prop="name">
                    <el-input v-model="productForm.value.keywords" type="text" autocomplete="off" />
                </el-form-item>
                <el-form-item label="商品备注" prop="gift">
                    <el-input v-model="productForm.value.note" type="textarea" autocomplete="off" />
                </el-form-item>
                    ...
                    <div v-if="promotionTypeState == '1'">
                        <el-form
                            ...
                            <el-form-item label="开始时间" prop="gift" style="margin-top:10px;">
                                <el-date-picker
                                    v-model="productForm.value.promotionStartTime"
                                    type="datetime"
                                    placeholder="选择开始时间"
                            ...
                            <el-form-item label="结束时间" prop="gift" style="margin-top:10px;">
                                <el-date-picker
                                    v-model="productForm.value.promotionEndTime"
                                    type="datetime"
                                    placeholder="选择结束时间"
                                    value-format="YYYY-MM-DD h:m:s"
                                />
                            ...
                            <el-form-item label="促销价格" prop="gift" style="margin-top:10px;">
                                <el-input-number v-model="productForm.value.promotionPrice" :precision="2" placeholder="输入促销价格"></el-input-number>
                            </el-form-item>
                        </el-form>
                    </div>
        ...
        <div v-if="active==2">
            ...
            >
                ...
                <el-form-item label="商品相册" prop="name">
                    <el-input v-model="productForm.value.unit" type="text" autocomplete="off" />
                </el-form-item>
                <el-form-item label="商品详情" prop="name">
                    <el-input v-model="productForm.value.detailHTML" type="textarea" autocomplete="off" />
                </el-form-item>
            </el-form>
        </div>
        <div v-if="active==3">
...
//   })
  ...
  onBeforeMount(async() => {
    if (isEdit.value) {
        // const res = await getProductDetail(route.query)
        const res = await getProductDetail({id: 6})
