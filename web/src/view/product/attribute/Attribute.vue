      ...
      <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="商品属性">
        <el-form :model="attributeForm" label-width="180px">
          ...
          <el-form-item label="商品类型">
            <el-input v-model="attributeForm.productType" autocomplete="off" />
          </el-form-item>
          ...
          <el-form-item label="属性值可选值列表">
            <el-input v-model="attributeForm.inputList" autocomplete="off" type="text"/>
          </el-form-item>
          ...
          <el-form-item label="排序属性">
            <el-input v-model="attributeForm.sort" autocomplete="off" />
          </el-form-item>
        </el-form>
        <template #footer>
